...
public class OrderRepositoryTest {
    ...
    void testSaveOrderSuccess() {
        ...
        Assertions.assertEquals(
                orderToBeInserted.getCreateDate(), savedOrder.getCreateDate(), "Order createdDate should be " + orderToBeInserted.getCreateDate());
        Assertions.assertEquals(
                orderToBeInserted.getProducts().size(), savedOrder.getProducts().size(), "Order products list should be equals");
    ...
    void testFindOrderSuccess() {
        ...
        loadedOrder.ifPresent(
                order -> {
                    ...
                    Assertions.assertEquals(
                            orderToBeInserted.getCreateDate(), order.getCreateDate(), "Order createdDate should be " + orderToBeInserted.getCreateDate());
                    Assertions.assertEquals(
                            orderToBeInserted.getProducts().size(), order.getProducts().size(), "Order products list should be equals");
                });
    }
